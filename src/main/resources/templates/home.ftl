...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="${request.contextPath}/static/css/amazeui.css" rel="stylesheet" type="text/css" />
		<link href="${request.contextPath}/static/css/admin.css" rel="stylesheet" type="text/css" />

		<link href="${request.contextPath}/static/css/demo.css" rel="stylesheet" type="text/css" />

		<link href="${request.contextPath}/static/css/hmstyle.css" rel="stylesheet" type="text/css"/>
		<link href="${request.contextPath}/static/css/skin.css" rel="stylesheet" type="text/css" />
		<script src="${request.contextPath}/static/js/jquery.min.js"></script>
		<script src="${request.contextPath}/static/js/amazeui.min.js"></script>
